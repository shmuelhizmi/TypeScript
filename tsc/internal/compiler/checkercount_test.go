...
func TestCheckerCountForGenericPressure(t *testing.T) {
	...
	tests := []struct {
		...
		{"vscode: 7 thousand constructs over 16 million weight", 7_000, 16_000_000, sourceDominatedCheckerCount},
		{"fluentui: 839 constructs over 393 thousand weight", 839, 393_000, sourceDominatedCheckerCount},
		{"exactly at the threshold", 10, 1_000, sourceDominatedCheckerCount},
		{"just above the threshold", 11, 1_000, baseCheckerCount},
		{"opencode: 134 thousand constructs over 1.7 million weight", 134_000, 1_700_000, baseCheckerCount},
