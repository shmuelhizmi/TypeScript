//// [tests/cases/compiler/narrowingAcrossArrayBindingPatternHole.ts] ////

//// [narrowingAcrossArrayBindingPatternHole.ts]
...
//// [narrowingAcrossArrayBindingPatternHole.js]
"use strict";
function narrowAcrossHole(value) {
    value = "text";
    const [, second] = pair;
