...
declare namespace ts {
    ...
    export enum SyntaxKind {
        ColonEqualToken = 0,
        ColonEqualCloseParenToken = 1,
        ColonEqualGreaterThanToken = 2,
        Unknown = 3,
        EndOfFileToken = 4,
        ...
        WhitespaceTrivia = 8,
        ShebangTrivia = 9,
        ConflictMarkerTrivia = 10,
        NumericLiteral = 11,
        BigIntLiteral = 12,
        StringLiteral = 13,
        JsxText = 14,
        JsxTextAllWhiteSpaces = 15,
        RegularExpressionLiteral = 16,
        ...
        QuestionDotToken = 31,
        LessThanToken = 32,
        LessThanSlashToken = 33,
        GreaterThanToken = 34,
        LessThanEqualsToken = 35,
        GreaterThanEqualsToken = 36,
        EqualsEqualsToken = 37,
        ExclamationEqualsToken = 38,
        EqualsEqualsEqualsToken = 39,
        ExclamationEqualsEqualsToken = 40,
        EqualsGreaterThanToken = 41,
        PlusToken = 42,
        MinusToken = 43,
        AsteriskToken = 44,
        AsteriskAsteriskToken = 45,
        SlashToken = 46,
        PercentToken = 47,
        PlusPlusToken = 48,
        MinusMinusToken = 49,
        ...
        LastLiteralToken = 17,
        FirstTemplateToken = 17,
        LastTemplateToken = 20,
        FirstBinaryOperator = 32,
