namespace ts {
    ...
    const textToKeywordObj: MapLike<KeywordSyntaxKind> = {
        מודל: SyntaxKind.ModuleKeyword,
        מרחב: SyntaxKind.NamespaceKeyword,
        אף_פעם: SyntaxKind.NeverKeyword,
        חדש: SyntaxKind.NewKeyword,
        כלום: SyntaxKind.NullKeyword,
        מספר: SyntaxKind.NumberKeyword,
        תיבה: SyntaxKind.ObjectKeyword,
        חבילה: SyntaxKind.PackageKeyword,
        פרטי: SyntaxKind.PrivateKeyword,
        שמור: SyntaxKind.ProtectedKeyword,
        ציבורי: SyntaxKind.PublicKeyword,
        מחליף: SyntaxKind.OverrideKeyword,
        קריא: SyntaxKind.ReadonlyKeyword,
        קח_עכשיו: SyntaxKind.RequireKeyword,
        עולם: SyntaxKind.GlobalKeyword,
        החזר: SyntaxKind.ReturnKeyword,
        שים: SyntaxKind.SetKeyword,
        סטטיק: SyntaxKind.StaticKeyword,
        מחרוזת: SyntaxKind.StringKeyword,
        הורה: SyntaxKind.SuperKeyword,
        השוה: SyntaxKind.SwitchKeyword,
        סמל: SyntaxKind.SymbolKeyword,
        אני: SyntaxKind.ThisKeyword,
        זרוק: SyntaxKind.ThrowKeyword,
        חיובי: SyntaxKind.TrueKeyword,
        נסה: SyntaxKind.TryKeyword,
        סוג: SyntaxKind.TypeKeyword,
        סוג_של: SyntaxKind.TypeOfKeyword,
        לא_הוכרז: SyntaxKind.UndefinedKeyword,
        מיוחד: SyntaxKind.UniqueKeyword,
        לא_ידוע: SyntaxKind.UnknownKeyword,
        אוויר: SyntaxKind.VoidKeyword,
        כל_עוד: SyntaxKind.WhileKeyword,
        עם: SyntaxKind.WithKeyword,
        הורד: SyntaxKind.YieldKeyword,
        בסבלנות: SyntaxKind.AsyncKeyword,
        חכה: SyntaxKind.AwaitKeyword,
        של: SyntaxKind.OfKeyword,
        הכל: SyntaxKind.AnyKeyword,
        בסיס: SyntaxKind.AbstractKeyword,
        לפעמים_להיות_כמו: SyntaxKind.AsKeyword,
        בטוח: SyntaxKind.AssertsKeyword,
        מספר_שלם_גדול: SyntaxKind.BigIntKeyword,
        בוליאני: SyntaxKind.BooleanKeyword,
        שבור: SyntaxKind.BreakKeyword,
        אפשרות: SyntaxKind.CaseKeyword,
        תפוס: SyntaxKind.CatchKeyword,
        כיתה: SyntaxKind.ClassKeyword,
        המשך: SyntaxKind.ContinueKeyword,
        קבוע: SyntaxKind.ConstKeyword,
        השם: SyntaxKind.ConstructorKeyword,
        מנפה: SyntaxKind.DebuggerKeyword,
        הכרז: SyntaxKind.DeclareKeyword,
        מרכזי: SyntaxKind.DefaultKeyword,
        מחק: SyntaxKind.DeleteKeyword,
        תעשה: SyntaxKind.DoKeyword,
        אחרת: SyntaxKind.ElseKeyword,
        אפשרויות: SyntaxKind.EnumKeyword,
        חשוף: SyntaxKind.ExportKeyword,
        ממשיך: SyntaxKind.ExtendsKeyword,
        שלילי: SyntaxKind.FalseKeyword,
        בסוף: SyntaxKind.FinallyKeyword,
        בשביל: SyntaxKind.ForKeyword,
        מ: SyntaxKind.FromKeyword,
        פעולה: SyntaxKind.FunctionKeyword,
        בקש: SyntaxKind.GetKeyword,
        אם: SyntaxKind.IfKeyword,
        מיצג: SyntaxKind.ImplementsKeyword,
        קח: SyntaxKind.ImportKeyword,
        ב: SyntaxKind.InKeyword,
        אולי: SyntaxKind.InferKeyword,
        בכיתה: SyntaxKind.InstanceOfKeyword,
        מבנה: SyntaxKind.InterfaceKeyword,
        פנימי: SyntaxKind.IntrinsicKeyword,
        הוא: SyntaxKind.IsKeyword,
        שדה_של: SyntaxKind.KeyOfKeyword,
        משתנה: SyntaxKind.LetKeyword,
        ...
        var: SyntaxKind.VarKeyword, // we do not use var in hebrew
    ...
    export function createScanner(languageVersion: ScriptTarget,
        ...
        function getIdentifierToken(): SyntaxKind.Identifier | KeywordSyntaxKind {
            ...
            if (len >= 2 && len <= 12) {
                ...
                if ((ch >= CharacterCodes.a && ch <= CharacterCodes.z) || (ch >= CharacterCodes.א && ch <= CharacterCodes.ת)) {
